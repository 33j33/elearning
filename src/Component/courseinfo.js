    ...
    render() {
        return (
            <div>
                ...
                <Collapse style={{marginLeft: 300, marginRight: 300, marginTop: 20, fontSize: 15}} defaultActiveKey={['1']} onChange={this.callback}>
                    <Panel header="Full Course" key="2">
                        <p>Teacher's avalaible slots:
                            <ul>
                                <li>Monday <Radio.Group onChange={this.onChange1} value={this.state.value1} style={{marginLeft: 30}}>
                                    <Radio value={1}>8:00-9:00</Radio>
                                    <Radio value={2}>12:00-13:00</Radio>
                                    <Radio value={3}>16:00-17:00</Radio>
                                </Radio.Group></li>
                                <li>Wednesday <Radio.Group onChange={this.onChange2} value={this.state.value2} style={{marginLeft: 8}}>
                                    <Radio value={4}>10:00-11:00</Radio>
                                    <Radio value={5}>11:00-12:00</Radio>
                                </Radio.Group></li>
                                <li>Friday <Radio.Group onChange={this.onChange3} value={this.state.value3} style={{marginLeft: 45}}>
                        ...
                        <p>Course Fees: ₹2000     
                            <Button type="primary" htmlType="submit" style={{marginLeft: 15}}>Pay</Button>
                        </p>
                    </Panel>
                    <Panel header="Half Course" key="3">
                        <Row>Choose slots here:
                            <Button onClick={this.handleAdd} style={{marginLeft: 15, marginBottom: 16,}}>
                            <PlusCircleOutlined />
                            </Button>
                        </Row>
